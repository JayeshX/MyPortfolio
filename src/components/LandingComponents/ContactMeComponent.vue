<template>
    <section class="bg-blue-50 dark:bg-[#151515]" id="contact-me">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <p class="text-base font-semibold uppercase tracking-wide text-blue-600 dark:text-white">
                    Contact
                </p>
                <h2
                ...
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-[#cb1b28] "> I will get back to you as soon as I can
                </p>
            </div>
        </div>
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-white">
                        I am including my contact info you can directly contact me using this info
                        otherwise just use the field to contact me
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 dark:bg-[#cb1b28] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">My Address
                                </h3>
                                <p class="text-gray-600 dark:text-white">Juinagar, Navi Mumbai</p>
                                <p class="text-gray-600 dark:text-white">Maharashtra, India</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 dark:bg-[#cb1b28] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-white">Mail: jayeshkirtane218@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 dark:bg-[#cb1b28] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</h3>
                                <p class="text-gray-600 dark:text-white">Monday - Friday: 08:00 - 17:00</p>
                                <p class="text-gray-600 dark:text-white">Saturday &amp; Sunday: 08:00 - 12:00</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm">
                        ...
                        <div class="text-center">
                            <button type="submit" class="w-full bg-blue-800 text-white px-6 py-3 font-xl dark:bg-[#cb1b28] rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
